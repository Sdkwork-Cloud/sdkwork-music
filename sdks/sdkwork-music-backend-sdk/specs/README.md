...
This directory is the local SDKWork component contract for `@sdkwork/music-backend-sdk-family`.

- Component root: `sdkwork-music/sdks/sdkwork-music-backend-sdk`
