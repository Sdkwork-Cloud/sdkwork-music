...
Domain: content
Capability: routes-music-backend-api
Package type: rust-route-crate
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-routes-music-backend-api`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
