...
This directory is the local SDKWork component contract for `sdkwork-routes-music-backend-api`.

- Component root: `sdkwork-music/crates/sdkwork-routes-music-backend-api`
