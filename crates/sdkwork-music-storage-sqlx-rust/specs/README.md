...
This directory is the local SDKWork component contract for `sdkwork-music-storage-sqlx-rust`.

- Component root: `sdkwork-music/crates/sdkwork-music-storage-sqlx-rust`
