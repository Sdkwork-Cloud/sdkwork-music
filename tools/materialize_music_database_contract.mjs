...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_music_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'music_', owner: 'music-platform', domain: 'music' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into music database contract\n`);
