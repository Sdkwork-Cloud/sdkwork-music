...
const schemas = {
  ...
  MusicAiGenerationTask: objectSchema(
    ["id", "tenantId", "userId", "prompt", "styleTags", "modelProvider", "modelName", "status", "moderationStatus"],
    {
      id: idSchema(),
      tenantId: idSchema(),
      projectId: idSchema(),
      ...
      styleTags: stringArray(32),
      modelProvider: stringSchema({ minLength: 1, maxLength: 64 }),
  ...
  MusicAiGenerationTaskCommand: objectSchema(["prompt", "styleTags", "modelProvider", "modelName"], {
    projectId: idSchema(),
    prompt: stringSchema({ minLength: 1, maxLength: 2000 }),
    lyricsPrompt: stringSchema({ maxLength: 4000 }),
    styleTags: stringArray(32),
...
const appRoutes = [
  ...
  route("get", "/app/v3/api/music/ai/style_presets", "ai.stylePresets.list", { schema: arrayOf("MusicAiStylePreset") }, [queryParam("status"), limitParam()], null, APP_ROUTE_CRATE, { tenantScope: "user", permission: "music.aiGeneration.read" }),
  route("get", "/app/v3/api/music/ai/prompt_templates", "ai.promptTemplates.list", { schema: arrayOf("MusicAiPromptTemplate") }, [queryParam("status"), limitParam()], null, APP_ROUTE_CRATE, { tenantScope: "user", permission: "music.aiGeneration.read" }),
  route("get", "/app/v3/api/music/ai/generation/tasks", "ai.generation.tasks.list", { schema: arrayOf("MusicAiGenerationTask") }, [queryParam("status"), limitParam()], null, APP_ROUTE_CRATE, { tenantScope: "user", permission: "music.aiGeneration.read" }),
  route("post", "/app/v3/api/music/ai/generation/tasks", "ai.generation.tasks.create", { schema: ref("MusicAiGenerationTask") }, [], "MusicAiGenerationTaskCommand", APP_ROUTE_CRATE, { tenantScope: "user", permission: "music.aiGeneration.create", idempotent: true }),
  route("get", "/app/v3/api/music/ai/generation/tasks/{taskId}", "ai.generation.tasks.retrieve", { schema: ref("MusicAiGenerationTask") }, [pathParam("taskId")], null, APP_ROUTE_CRATE, { tenantScope: "user", permission: "music.aiGeneration.read" }),
];
...
const backendRoutes = [
  ...
  route("get", "/backend/v3/api/music/ai/style_presets", "ai.stylePresets.management.list", { schema: arrayOf("MusicAiStylePreset") }, [queryParam("status"), limitParam()], null, BACKEND_ROUTE_CRATE),
  route("post", "/backend/v3/api/music/ai/style_presets", "ai.stylePresets.create", { schema: ref("MusicAiStylePreset") }, [], "MusicAiStylePresetCommand", BACKEND_ROUTE_CRATE, { auditEvent: "music.aiStylePreset.create", idempotent: true }),
  route("patch", "/backend/v3/api/music/ai/style_presets/{presetId}", "ai.stylePresets.update", { schema: ref("MusicAiStylePreset") }, [pathParam("presetId")], "MusicAiStylePresetCommand", BACKEND_ROUTE_CRATE, { auditEvent: "music.aiStylePreset.update" }),
  route("get", "/backend/v3/api/music/ai/prompt_templates", "ai.promptTemplates.management.list", { schema: arrayOf("MusicAiPromptTemplate") }, [queryParam("status"), limitParam()], null, BACKEND_ROUTE_CRATE),
  route("post", "/backend/v3/api/music/ai/prompt_templates", "ai.promptTemplates.create", { schema: ref("MusicAiPromptTemplate") }, [], "MusicAiPromptTemplateCommand", BACKEND_ROUTE_CRATE, { auditEvent: "music.aiPromptTemplate.create", idempotent: true }),
  route("patch", "/backend/v3/api/music/ai/prompt_templates/{templateId}", "ai.promptTemplates.update", { schema: ref("MusicAiPromptTemplate") }, [pathParam("templateId")], "MusicAiPromptTemplateCommand", BACKEND_ROUTE_CRATE, { auditEvent: "music.aiPromptTemplate.update" }),
  route("get", "/backend/v3/api/music/ai/generation/credit_ledger", "ai.generation.creditLedger.list", { schema: arrayOf("MusicAiGenerationCreditLedgerEntry") }, [queryParam("user_id"), queryParam("task_id"), limitParam()], null, BACKEND_ROUTE_CRATE),
  route("get", "/backend/v3/api/music/ai/generation/tasks", "ai.generation.tasks.management.list", { schema: arrayOf("MusicAiGenerationTask") }, [queryParam("status"), queryParam("user_id"), limitParam()], null, BACKEND_ROUTE_CRATE),
  route("post", "/backend/v3/api/music/ai/generation/tasks/{taskId}/moderate", "ai.generation.tasks.moderate", { schema: ref("MusicAiGenerationTask") }, [pathParam("taskId")], "MusicAiGenerationModerationCommand", BACKEND_ROUTE_CRATE, { auditEvent: "music.aiGenerationTask.moderate" }),
  route("post", "/backend/v3/api/music/ai/generation/tasks/{taskId}/publish", "ai.generation.tasks.publish", { schema: ref("MusicRelease") }, [pathParam("taskId")], "MusicAiGenerationPublishCommand", BACKEND_ROUTE_CRATE, { auditEvent: "music.aiGenerationTask.publish", idempotent: true }),
